...
import lsr.paxos.client.messages.ClientMessageFactory;
...
public class ClientTcpConnection {
    ...
    private final ClientTcpNetwork network;
     ...
     *            otherwise.
     */
    public ClientTcpConnection(ClientTcpNetwork network, PID replica, boolean active) {
        ...
        public void run() {
            ...
            try {
                while (true) {
                    ...
                    synchronized (ClientTcpConnection.this) { // Memory barrier for
                                                        // connected variable.
                        if (!connected) {
                            continue;
                        }
        ...
        public void run() {
            while (true) {
                ...
                while (true) {
                    ...
                    try {
                        message = ClientMessageFactory.create(input);
                ...
                try {
                    ...
                    try {
                        socket.connect(new InetSocketAddress(replica.getHostname(),
                                replica.getClientPort())); //.getReplicaPort()
