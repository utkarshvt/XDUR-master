...
public class RequestMessage extends ClientMessage {
     ...
     */
    public RequestMessage(long ClientId, int sequencenum, byte[] value) {
     ...
     */
    public RequestMessage(DataInputStream input) throws IOException {
        super(input);
    ...
    public ClientMessageType getType() {
        return ClientMessageType.Request;
    }
    ...
    public Request createRequest(){
    	RequestId requestId =  new RequestId(super.clientId, super.sequenceNum);
