...
//
//import lsr.common.BatchRequest;
...
//	private int timeout;
//
//	public static final AtomicInteger staticPrimary = new AtomicInteger(-1);
//
//	/**
...
//	 * 
//	 * @param replicas
//	 *            - information about replicas to connect to
//	 */
...
//		// staticPrimary.set(primary);
//		// System.err.println("random primary: " + primary);
//	}
//
//	/**
//	 * Creates new connection used by client to connect to replicas.
//	 * 
//	 * @param config
//	 *            - the configuration with information about replicas to connect
//	 *            to
//	 * @throws IOException
...
//	 *             if error occurs while sending request
//	 */
...
//						logger.warning("Reply: Invalid redirect received: "
//								+ currentPrimary
...
//					}
//					// if (Thread.currentThread().getName().startsWith("Work"))
//					// System.err.println("Client " + hashCode() +
//					// " working for " + Thread.currentThread().getName() +
//					// " REDIRECT from " + primary + " to " + currentPrimary);
//					waitForReconnect();
...
//				case BUSY:
//					stats.replyBusy();
//					throw new ReplicationException(new String(
//							clientReply.getValue()));
//
//				default:
...
//	}
//
//	private final void setStaticPrimary(int currentPrimary)
//	{
//		int currentA = -1;
//		if ((currentA = staticPrimary.get()) != currentPrimary)
//		{
//			staticPrimary.compareAndSet(currentA, currentPrimary);
//
//			// System.err.println("primary: " + currentPrimary);
//		}
//	}
//
//	public synchronized byte[] execute(Collection<byte[]> bytes)
//			throws ReplicationException
//	{
//		Request request = new BatchRequest(nextRequestId(), bytes);
//		ClientCommand command = new ClientCommand(CommandType.REQUEST, request);
//
//		while (true)
//		{
...
//					stats.replyOk(reply.getRequestId());
//					average.add(time);
//					setStaticPrimary(primary);
//					return reply.getValue();
//
//				case REDIRECT:
//					int currentPrimary = PrimitivesByteArray.toInt(clientReply
//							.getValue());
//					System.err.println("redirect " + currentPrimary);
//					setStaticPrimary(currentPrimary);
//
//					if (currentPrimary < 0 || currentPrimary >= n)
//					{
//						// Invalid ID. Ignore redirect and try next replica.
...
//			{
//				cleanClose();
//				logger.warning("Connect to " + nextNode + " failed: "
//						+ e.getMessage());
...
//		{
//			// if (Thread.currentThread().getName().startsWith("Work"))
//			// System.err.println("Client " + hashCode() + " working for " +
//			// Thread.currentThread().getName() + " sleeping for " +
//			// TIME_TO_RECONNECT + "ms.");
...
//		initConnection();
//
//		logger.info("Connected [p" + replicaId + "]. Timeout: "
//				+ socket.getSoTimeout());
//		// if (Thread.currentThread().getName().startsWith("Work"))
//		// System.err.println("Client " + hashCode() + " working for " +
//		// Thread.currentThread().getName() + " succesfully connected to " +
//		// replicaId);
//	}
//
...
//					clientId) : new ClientStats.ClientStatsNull();
